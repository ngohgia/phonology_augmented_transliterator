...
for j in range(len(sizes)):
  ...
  for itr in range(all_itr+1):
    curr_data_set = 'size' + str(size) + '_iter' + str(itr)

    root_dir = os.path.join('/home/ngohgia/Work/Cantonese_onset-final_transliterator', 'exp_170314', 'size' + str(size), curr_data_set)
